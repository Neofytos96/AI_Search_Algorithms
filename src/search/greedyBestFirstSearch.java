...
public class greedyBestFirstSearch {
    ...
    PriorityQueue<greedyBestFirstNode> frontier;

    public greedyBestFirstSearch(State initialState){
        frontier = new PriorityQueue();
        frontier.add(new greedyBestFirstNode(initialState,null,null));
    }
            ...
            if(n.getState().isGoal()){
                ...
                for(Action action:actions){
                    ...
                    if(!n.alreadyExplored(child)){
                        frontier.add(new greedyBestFirstNode(child,n,action));
                    }
                }
            }
        }
...
//        int [][] v = {{1,2,5},{3,4,0},{6,7,8}};
        ...
        greedyBestFirstSearch as = new greedyBestFirstSearch(st);
